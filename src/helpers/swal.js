...
const swalConfig = {
  success: {
    ...
    iconHtml: `<svg width="21px" height="21px" viewBox="0 0 21 21" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <g id="Success_alert" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="Hover" transform="translate(2.000000, 2.000000)" strokeWidth="1.5">
    ...
    <g id="Alert_close" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
  ...
  error: {
    ...
    <g id="Error-icon---Notification" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Hover-Copy" transform="translate(7.000000, 6.000000)">
            <rect id="Rectangle" stroke="#D50000" strokeWidth="1.5" fill="#D50000" x="-0.75" y="-0.75" width="17.5" height="17.5" rx="8.75"></rect>
    ...
    <g id="Close-Notification" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <polygon id="path-1" fill="#D50000" fillRule="nonzero" transform="translate(6.000000, 6.000000) rotate(45.000000) translate(-6.000000, -6.000000) " points="7 0 7 5 12 5 12 7 6.999 7 7 12 5 12 4.999 7 0 7 0 5 5 5 5 0"></polygon>
    </g>
</svg>`,
    customClass: {
      popup: 'error-popup',
