        ...
        <div className="row">
          <div className="col-md-6 form-group">
            ...
            <input
              ...
              type="text"
              defaultValue={
                data?.daily_available_hours ? data.daily_available_hours : null
              }
              disabled={true}
              onChange={e =>
        ...
        <div className="row">
          ...
          <div className="col-md-6 form-group">
            ...
            <DateRangePicker
              ...
              error={
                ((mode === MODE.VIEW_AND_AMEND ? true : false) || !scheduler) &&
                showError &&
                showError.indexOf('block_date_range') !== -1 &&
                statusSap?.toUpperCase() === 'ACTIVE'
              }
            />
            {((mode === MODE.VIEW_AND_AMEND ? true : false) || !scheduler) &&
        ...
        <div className="row">
          <div className="col-md-6 form-group">
            ...
            <DateRangePicker
              ...
              error={
                showError &&
                showError.indexOf('other_terminal_mobilization_1_date') !== -1
              }
            />
            {showError &&
              showError.indexOf('other_terminal_mobilization_1_date') !==
                -1 && (
                <p className="error">Please select MOBILIZED TERMINAL DATE 1</p>
              )}
          </div>
          <div className="col-md-6 form-group">
            ...
            <AWSMDropdown
              ...
              error={
                showError &&
                showError.indexOf('other_terminal_mobilization_1_name') !== -1
              }
            />
            {showError &&
              showError.indexOf('other_terminal_mobilization_1_name') !==
                -1 && (
                <p className="error">Please select MOBILIZED TERMINAL NAME 1</p>
              )}
          </div>
        </div>
        <div className="row">
          <div className="col-md-6 form-group">
            ...
            <DateRangePicker
              ...
              error={
                showError &&
                showError.indexOf('other_terminal_mobilization_2_date') !== -1
              }
            />
            {showError &&
              showError.indexOf('other_terminal_mobilization_2_date') !==
                -1 && (
                <p className="error">Please select MOBILIZED TERMINAL DATE 2</p>
              )}
          </div>
          <div className="col-md-6 form-group">
            ...
            <AWSMDropdown
              ...
              error={
                showError &&
                showError.indexOf('other_terminal_mobilization_2_name') !== -1
              }
            />
            {showError &&
              showError.indexOf('other_terminal_mobilization_2_name') !==
                -1 && (
                <p className="error">Please select MOBILIZED TERMINAL NAME 2</p>
              )}
          </div>
        </div>
      </form>
