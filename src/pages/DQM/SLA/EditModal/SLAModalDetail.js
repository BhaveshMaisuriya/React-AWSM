        ...
        <Modal isOpen={openModalDetail} size={`lg`} className="modal-detail">
          <div className="variance-control-container">
            <div className="d-flex align-items-center justify-content-between px-4 pt-4 pb-2">
              <h3 className="variance-label">{'Edit detail'}</h3>
              ...
              <div className="w-100">
                <div className="px-2">
                  <Table className="sla-detail-table">
                    <thead>
                      <tr>
                        <th className="header hd_1">
                          itemno.
                        </th>
                        <th className="header hd_2">description</th>
                        <th className="header hd_3">kpi</th>
                        <th className="header hd_4">
                          mitigation plan
                        </th>
                        <th className="header hd_5">
                          action by
                        </th>
                        <th className="header hd_6">
                          module
                        </th>
                        <th className="header hd_7">
                          remarks
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                        <tr className="ck-content">
                            <td className="" colSpan={7}><CustomCKEditor data={data} /></td>
                        </tr>
