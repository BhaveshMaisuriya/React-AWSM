    ...
    <div className="terminal-product">
      {isConfirmDelete && (
        <div className="d-flex align-items-center justify-content-center delete-confirm">
          ...
          <button className="btn-dan ml-2" onClick={onCancel}>
            Cancel
          </button>
      ...
      <div className="row">
        <div className="col-3 form-group mb-0">
          <label htmlFor="productCode">
            PRODUCT CODE{' '}
            {isDisabledField ? '' : <span className="red-error">*</span>}
          </label>
          <AWSMInput
            key={value.code}
            disabled={true}
        ...
        <div className="col-3 form-group mb-0 h-40">
          <label
            className={`${renderExceedError(
              'terminal_product_density',
              10000
            )}`}
          >
            PRODUCT DENSITY
      ...
      <div className="row marginTop20">
        ...
        <div className="col-3 form-group">
          <label className="" htmlFor="volume1">
            VOLUME (L) 1
          </label>
          <AWSMInputNumber
