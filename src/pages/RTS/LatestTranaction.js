  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <Card>
          <CardBody>
            <CardTitle className="mb-4">{this.props.petDataSource === 0 ? "ORDER BANK" : "ROAD TANKER"}</CardTitle>
              ...
              <table className="table table-centered table-nowrap mb-0">
                <thead className="thead-light">
                  <tr>
                    ...
                    <th>ID</th>
                    <th>{this.props.petDataSource === 0 ? "CUST ID" : "VEHICLE ID"}</th>
                    <th>{this.props.petDataSource === 0 ? "PRIORITY" : "TRANSPORTER NAME"}</th>
                    <th>{this.props.petDataSource === 0 ? "CUST NAME" : "CHATTERING"}</th>
                    <th>{this.props.petDataSource === 0 ? "PRODUCT" : "AVAILABILITY STATUS"}</th>
                    <th>{this.props.petDataSource === 0 ? "ORDER TYPE" : "Effective Dates"}</th>
                    <th>{this.props.petDataSource === 0 ? "VOL" : "Effective Dates"}</th>
                    <th>{this.props.petDataSource === 0 ? "ROUTE ID" : "Effective Dates"}</th>
                    <th>{this.props.petDataSource === 0 ? "DN NO" : "Effective Dates"}</th>
                    <th>{this.props.petDataSource === 0 ? "SHIPMENT NUMBER" : "Effective Dates"}</th>
