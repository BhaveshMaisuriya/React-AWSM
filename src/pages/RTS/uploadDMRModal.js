...
import { getUploadDMR, setUploadDMR } from 'store/actions'
...
function UploadDMRModal(props) {
  ...
  return (
    <React.Fragment>
      ...
      <Modal isOpen={props.open} id="auditLog-modal">
        <ModalHeader close={<CloseButton handleClose={props.onCancel} />}>
          <h3>Upload DMR</h3>
        </ModalHeader>
        <ModalBody>
          <div
...
export default connect(mapStateToProps, mapDispatchToProps)(UploadDMRModal)
